  ...
  const steps: Step[] = [
    {
      number: "01",
      title: "Staking ETH",
      icon: "/images/icon_eth.svg",
      description: "Deposit the amount of $ETH you wish to stake on Ethliquid."
    },
    {
      number: "02",
      title: "Receive $LSTETH",
      icon: "/images/icon_lsteth.svg",
      description: "Receive $LSTETH as a staking reward, which appreciates in value relative to $ETH after each epoch."
    },
    {
      number: "03",
      ...
      description: "Utilize $LSTETH across various DeFi protocols on the Ethereum network, or swap it back to $ETH at any time. Maximize your returns by exploring additional DeFi yields on top of your staking rewards."
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: "Staking is a way to earn rewards for holding certain cryptocurrencies. When you stake your ETH, you lock it up to help maintain the security and operations of the Ethereum network. In return, you earn rewards, similar to earning interest in a traditional savings account."
    },
    {
      id: 2,
      question: "How Does Staking Work?",
      answer: "When you stake your ETH, it is locked into the Ethereum blockchain, which helps in maintaining network security. Based on the protocol's rules, you earn a reward periodically, often paid in ETH or a liquid staking token."
    },
    {
      id: 3,
      question: "What is the Minimum Amount Required to Stake?",
      answer: "The minimum amount required to stake varies depending on the protocol. For ETH staking through our platform, you can start with as little as 0.01 ETH."
    },
    {
      id: 4,
    ...
    },
    {
      ...
      answer: "Staking rewards are calculated based on several factors: the amount staked, staking duration, network inflation rate, and overall network participation. Our current APY is approximately 4.2%."
    },
    {
      id: 7,
      question: "What Are Validator Nodes?",
      answer: "Validator nodes are computers that participate in the Ethereum network by validating and processing transactions. They play a crucial role in maintaining the network's security and decentralization."
    },
    {
      id: 8,
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mt-16">
              <div className="text-left w-full">
                ...
                <h1 className="mb-6 tracking-tight leading-tight font-[500]">
                  ...
                  <span className="block text-[3rem] md:text-[4.0rem] font-[800]">STAKE YOUR ETH</span>
                </h1>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-4">
                  <div className="grid grid-cols-3 gap-8 w-full md:w-auto">
                    <div>
                      <div className="text-2xl md:text-3xl font-bold mb-2">4.2%</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              ...
              <div className="flex flex-col p-6 md:p-8 rounded-2xl transition-all duration-300 hover:bg-[#001070] hover:-translate-y-2 cursor-pointer">
                ...
                <div className="space-y-6">
                  ...
                  <div className="text-[4.5rem] font-[600] leading-none">4.2%</div>
