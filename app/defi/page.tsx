...
export default function DefiPage() {
  const strategies = [
    {
      name: "Vault Strategy on EigenLayer",
      icon: "/images/icon01.png",
      address: "0x...eigenlayer",
      features: [
        { name: "ETH rewards", value: true },
        { name: "Open source", value: true },
        { name: "Audited", value: true }
      ],
      action: "Supply LSTETH"
    },
    {
      name: "Provide liquidity on Curve",
